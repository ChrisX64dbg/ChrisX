...
$tweaks = @(
	...
	"InstallMVC", #ChrisTool install Microsoft Visualstudio required for HPET service!
	"Install7Zip",
	"InstallChocoUpdates",
	"EnableUlimatePower",    # ChrisTool don't change order it will break other functions! just disable if you want with #
	### ChrisTool Windows Defender Settings! Don't Change Order Just Disable with # If You Don't want it ###
	...
	### Unpinning ###
	"UnpinStartMenuTiles",
        ### ChrisTool Quality Of Life Tweaks ###
	"QOL",
        ### ChrisTool Gaming Tweaks ###
...
Function InstallTitusProgs {
	...
	Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChrisTool/Windows10GamingFocus/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
Function QOL {
       	Write-Output "Enabling ChrisTool Quality of Life Tweaks..."
	$errpref = $ErrorActionPreference #save actual preference
        $ErrorActionPreference = "silentlycontinue"
...
#ChrisTool Ultimate CLeaner
Function UltimateCleaner {
    Write-Host "Running ChrisTool Ultimate Cleaner => Temp folders & Flush DNS + Reset IP...."
...
Function Finished {
	...
	Set-ItemProperty -Path "HKLM:\SOFTWARE\Policies\Microsoft\Windows\System" -Name "AllowClipboardHistory" -Type DWord -Value 1
        cmd /c 'REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "Manufacturer" /t REG_SZ /d "This PC is Optimized by Chris" /f 2>nul' >$null
        cmd /c 'REG ADD "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\OEMInformation" /v "SupportURL" /t REG_SZ /d "https://discord.gg/7VurtY4g8M" /f 2>nul' >$null
	Start-Sleep -s 5
        Write-Output "Done! Please Reboot Your PC! Don't forget to follow me on Social Media."
        Start-Process "https://discord.gg/7VurtY4g8M"
}
...
Function RequireAdmin {
	If (!([Security.Principal.WindowsPrincipal][Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
		Start-Process Powershell -Argumentlist '-ExecutionPolicy bypass -NoProfile -command "irm "https://github.com/ChrisTool/Windows10GamingFocus/raw/master/win10debloatandgamingtweaks.ps1" | iex"' -Verb RunAs
		Exit
	}
}
...
Function CreateRestorePoint {
  ...
  Checkpoint-Computer -Description "BeforeChrisToolScript" -RestorePointType "MODIFY_SETTINGS"
}
